...
public class CustomPet_Sheep extends PetConfiguration{

    public CustomPet_Sheep(PathFinder pathFinder){
        super(pathFinder);
    }

    public CustomPet_Sheep(PathFinder pathFinder, Player player) {
